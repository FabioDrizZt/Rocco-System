```mermaid
graph TD
    subgraph FlujoPrincipal [Flujo Principal]
    ...
    subgraph Op1 [Opción 1: Cargar Usuario]
        direction LR
    ...
    subgraph Op2 [Opción 2: Ver Cursos]
        direction LR
        Choice -- "2" --> Proc2_Show[Listar cursos disponibles]
        Proc2_Show --> ShowMenu
    end

    subgraph Op6 [Opción 6: Enviar Sugerencia]
        direction LR
    ...
    subgraph AuthFuncs [Funciones con Autenticación]
    ...
    subgraph Login [Sub-flujo: Iniciar Sesión]
    ...
    subgraph Flow3 [Flujo 'Ver Mis Cursos']
    ...
    subgraph Flow4 [Flujo 'Inscribirse']
    ...
    subgraph Flow5 [Flujo 'Cancelar Inscripción']
